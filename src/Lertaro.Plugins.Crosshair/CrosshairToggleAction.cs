...
/// <summary>动作菜单项：切换准星显示。热键留空（由宿主分配或后续版本自带注册）。</summary>
internal sealed class CrosshairToggleAction : ISearchResultAction
{
    public string Name => "屏幕准星";

    public string Description => "显示 / 隐藏屏幕中央的自定义准星（点击穿透，不影响游戏操作）";
...
{
    public string Name => "准星编辑器";

    public string Description => "可视化调整准星：颜色/描边/中心点/内外线拖滑杆、实时预览，还能粘贴 VALORANT 准星代码，保存即生效";

    public string GroupName => "准星";

    public string DisplayName => "准星编辑器（可视化调整）";
...
{
    public string Name => "打开屏幕准星";

    public string Description => "立即显示屏幕中央的自定义准星（点击穿透，不影响游戏操作）";

    public string GroupName => "准星";

    public string DisplayName => "打开屏幕准星";
...
{
    public string Name => "关闭屏幕准星";

    public string Description => "隐藏屏幕中央的自定义准星";

    public string GroupName => "准星";

    public string DisplayName => "关闭屏幕准星";
